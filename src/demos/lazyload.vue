<template>
  <div class="page-lazyload">
    <div class="page-title">Lazy Load</div>
    <ul class="page-lazyload__list">
      <li class="page-lazyload__listitem" v-for="item in list">
        <img v-lazy="item" class="page-lazyload__image">
      </li>
    </ul>
  </div>
</template>
